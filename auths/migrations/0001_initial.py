# Generated by Django 4.0 on 2023-01-31 01:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(blank=True, choices=[('Closer', 'Closer'), ('Appointment_setter', 'Appointment_setter'), ('Closer & Appointment_setter', 'Closer & Appointment_setter')], default='', max_length=125, null=True)),
                ...
                ('pay', models.CharField(blank=True, choices=[('Hourly', 'Hourly'), ('Commission', 'Commission'), ('Hourly+', 'Hourly+')], default='', max_length=10)),
                ...
                ('days_available', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='auths.days')),
                ('language', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='auths.language')),
                ('skills', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='auths.skills')),
