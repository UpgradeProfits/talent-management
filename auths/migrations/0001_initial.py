# Generated by Django 4.0 on 2023-02-19 19:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay', models.CharField(blank=True, choices=[('Hourly', 'Hourly'), ('Commission', 'Commission'), ('Hourly with commission', 'Hourly with commission')], default='', max_length=30)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auths.trainers'),
        ),
        migrations.AddField(
            model_name='extrafield',
            name='user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('workers', models.CharField(blank=True, choices=[('Closers', 'Closers'), ('Appointment Setters', 'Appointment Setters')], default='', max_length=100)),
                ...
                ('timezone', models.CharField(choices=[('Chicago (GMT-6)', 'Chicago (GMT-6)'), ('Los Angeles (GMT-8)', 'Los Angeles (GMT-8)'), ('Honolulu (GMT-10)', 'Honolulu (GMT-10)')], default='', max_length=20)),
                ('days', models.CharField(choices=[('Mon-Fri', 'Mon-Fri'), ('Mon-Sat', 'Mon-Sat')], default='', max_length=20)),
